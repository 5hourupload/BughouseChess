        ...
        if (x + 1 < 8)
        {
            if (positions[x + 1][y].empty)
            {
                ...
                if (positions[6][0].empty && positions[4][0].type.equals("king") && positions[4][0].color.equals("white"))
                {
                    ...
                    {
                        if (whiteCastleKing1 && positions[6][0].empty && !checkCheck(positions, 4, 0) && !checkCheck(positions, 5, 0) && !checkCheck(positions, 6, 0))
                        {
                    ...
                    {
                        if (whiteCastleKing2 && positions[6][0].empty && !checkCheck(positions, 4, 0) && !checkCheck(positions, 5, 0) && !checkCheck(positions, 6, 0))
                        {
                            moves.add(new Move(board, positions, x, y, 6, 0, "whiteKingCastle"));
                ...
                if (positions[6][7].empty && positions[4][7].type.equals("king") && positions[4][7].color.equals("black"))
                {
                    ...
                    if (board(board, positions) == 1)
                    {
                        if (whiteCastleKing1 && positions[6][7].empty && !checkCheck(positions, 4, 7) && !checkCheck(positions, 5, 7) && !checkCheck(positions, 6, 7))
                        {
                    ...
                    {
                        if (whiteCastleKing2 && positions[6][7].empty && !checkCheck(positions, 4, 7) && !checkCheck(positions, 5, 7) && !checkCheck(positions, 6, 7))
                        {
                            moves.add(new Move(board, positions, x, y, 6, 7, "blackKingCastle"));
            ...
            if (positions[x - 1][y].empty)
            {
                ...
                if (positions[2][0].empty && positions[1][0].empty && positions[4][0].type.equals("king"))
                {
                    ...
                    if (board(board, positions) == 1)
                    {
                        ...
                        if (whiteCastleQueen1 && positions[2][0].empty && !checkCheck(positions, 1, 0) && !checkCheck(positions, 2, 0) && !checkCheck(positions, 3, 0) && !checkCheck(positions, 4, 0))
                        {
                            positions[1][0].color = "";
                            positions[2][0].color = "";
                            positions[3][0].color = "";
                    ...
                    {
                        if (whiteCastleQueen2 && positions[2][0].empty && !checkCheck(positions, 1, 0) && !checkCheck(positions, 2, 0) && !checkCheck(positions, 3, 0) && !checkCheck(positions, 4, 0))
                        {
                            positions[1][0] .color = "";
                            positions[2][0].color = "";
                            positions[3][0].color = "";
                ...
                if (positions[2][7].empty && positions[1][7].empty && positions[4][7].type.equals("king"))
                {
                    ...
                    if (board(board, positions) == 1)
                    {
                        ...
                        if (whiteCastleQueen1 && positions[2][7].empty && !checkCheck(positions, 1, 7) && !checkCheck(positions, 2, 7) && !checkCheck(positions, 3, 7) && !checkCheck(positions, 4, 7))
                        {
                            positions[1][7].color = "";
                            positions[2][7].color = "";
                            positions[3][7].color = "";
                    ...
                    {
                        if (whiteCastleQueen2 && positions[2][7].empty && !checkCheck(positions, 1, 7) && !checkCheck(positions, 2, 7) && !checkCheck(positions, 3, 7) && !checkCheck(positions, 4, 7))
                        {
                            positions[1][7].color = "";
                            positions[2][7].color = "";
                            positions[3][7].color = "";
